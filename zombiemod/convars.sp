...
InitConVars()
{
	...
	AddConVar(ConVar_Zombie_SniperCritSpeed, CreateConVar("dod_zombiemod_sniper_crit_speed", "1.5",  "Speed multiplier of a zombie when critted by sniper",  FCVAR_PLUGIN, true, 1.0, true, 5.0));
