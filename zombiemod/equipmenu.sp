	...
	switch (menuAction)
	{
		case MenuAction_DrawItem:
		{
			switch (param)
			{
				...
				{
					return GetPlayerClass(client) == PlayerClass_Machinegunner || IsClientVIP(client) ? ITEMDRAW_DEFAULT : ITEMDRAW_DISABLED;
				}
				case Menu_Primary_Spring, Menu_Primary_K98_Scoped, Menu_Primary_MG42, Menu_Primary_Bazooka, Menu_Primary_Panzerschreck:
				{
					return IsClientVIP(client) ? ITEMDRAW_DEFAULT : ITEMDRAW_DISABLED;
				}
			}
		}
